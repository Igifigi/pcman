 ...
 * <p>
 * Use getSprite(col, row) with 0-based tile coordinates; returns a {@link #TILE_SIZE}×{@link #TILE_SIZE} subimage.
...
final class SpriteSheet {
     ...
     * @param posX starting at 0, column number of tile on the {@code SpriteSheet} counting from the <b>left</b>
     * @param posY starting at 0, row number of tile on the {@code SpriteSheet} counting from the <b>top</b>
     * @return a {@code BufferedImage} of the rectangle defined by {@link #posX}, {@link #posY}, {@link #TILE_SIZE}
     * 
